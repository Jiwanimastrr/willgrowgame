...
function BombGamePlayer({ pin, nickname }) {
  ...
  if (bombExploded || isSpectator) {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', padding: '2rem', background: 'var(--ow-darker)', color: 'white' }}>
        <h1 style={{ fontSize: '4rem', color: bombExploded ? 'var(--ow-red)' : '#888', transform: 'skewX(-5deg)' }}>
          {bombExploded ? 'BOOM! 탈락!' : '관전 모드'}
        </h1>
        <p style={{ fontSize: '1.5rem', fontFamily: 'Noto Sans KR' }}>
          다른 플레이어들을 응원하세요!
        </p>
      </div>
    );
  ...
  return (
    <div style={{ 
      ...
      <div style={{ textAlign: 'center', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <h2 style={{ fontSize: '2.5rem', margin: 0, color: 'var(--ow-blue)', transform: 'skewX(2deg)' }}>
        ...
        <div style={{ 
          ...
          fontFamily: 'Teko', 
          color: isMyTurn ? 'var(--ow-red)' : 'var(--ow-dark)',
          lineHeight: 1
        }}>
        ...
        {isMyTurn ? (
          <div style={{ background: 'var(--ow-darker)', padding: '2rem', borderRadius: '12px', transform: 'skewX(-2deg)', boxShadow: '0 10px 20px rgba(0,0,0,0.2)' }}>
            <h3 style={{ color: 'var(--ow-orange)', margin: '0 0 1rem 0', fontSize: '2rem' }}>🔥 내 차례입니다! 빨리 입력하세요! 🔥</h3>
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <input 
                ...
                placeholder="단어 입력..."
                style={{ fontSize: '2rem', padding: '1rem', border: '5px solid var(--ow-red)', borderRadius: '8px', width: '100%', boxSizing: 'border-box' }}
                autoFocus
              ...
              {isWaitingForJudge ? (
                ...
                <button type="submit" className="ow-button red" style={{ fontSize: '2rem', padding: '1rem' }}>
                  입력
                </button>
              )}
            </form>
          ...
          <div style={{ fontSize: '2rem', color: '#666', fontFamily: 'Noto Sans KR' }}>
            <strong style={{ color: 'var(--ow-orange)' }}>
      ...
      <div style={{ marginTop: 'auto', background: 'white', padding: '1rem', borderRadius: '8px', border: '2px solid #ccc' }}>
        <h4 style={{ margin: '0 0 0.5rem 0', color: 'var(--ow-dark)' }}>나온 단어들 (중복 불가)</h4>
